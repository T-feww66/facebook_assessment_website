...
<script>
    ...
    function show_bieu_do_pie_post_group_page(group, page) {
        ...
        const backgroundColors = ['#EF5350', '#BA68C8'];
    ...
    // === BIỂU ĐỒ brh: SỐ LƯỢNG BÀI VIẾT THEO TỪ KHOÁ ===
    ...
    async function evaluateBrand() {
        ...
        try {
            const response = await fetch('{{ config("services.api_url") }}/danh_gia_thuong_hieu/thuong_hieu', {
                method: "POST",
                headers: {
