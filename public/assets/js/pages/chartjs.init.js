!(function (l) {
    ...
    (r.prototype.respChart = function (r, o, e, a) {
        ...
        (r.prototype.init = function () {
            ...
            this.respChart(l("#doughnut"), "Doughnut", { labels: ["Desktops", "Tablets"], datasets: [{ data: [300, 210], backgroundColor: ["#0f9cf3", "#ebeff2"], hoverBackgroundColor: ["#0f9cf3", "#ebeff2"], hoverBorderColor: "#fff" }] });
            this.respChart(l("#pie"), "Pie", { labels: ["Desktops", "Tablets"], datasets: [{ data: [300, 180], backgroundColor: ["#1cbb8c", "#ebeff2"], hoverBackgroundColor: ["#1cbb8c", "#ebeff2"], hoverBorderColor: "#fff" }] });
            this.respChart(
                l("#bar"),
                "Bar",
                {
            ...
            this.respChart(l("#polarArea"), "PolarArea", {
                datasets: [{ data: [11, 16, 7, 18], backgroundColor: ["#fcb92c", "#1cbb8c", "#f32f53", "#0f9cf3"], label: "My dataset", hoverBorderColor: "#fff" }],
